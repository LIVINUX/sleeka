...
export const InternalTeamSection: React.FC = () => (
  <section className="py-20 px-6 bg-white">
    <div className="max-w-2xl mx-auto text-center">
      ...
      <Slide delay={0}>
        <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-4" style={{ color: '#5c0386' }}>
          Already Have An Internal Team?
        </h2>
      </Slide>

      <Slide delay={0.08}>
        <p className="text-xl md:text-2xl font-bold mb-10 text-center" style={{ color: '#000' }}>
          We Don't Replace Great Teams.<br className="hidden md:block" /> We Help Them Do More.
        </p>
      </Slide>

      <Slide delay={0.14}>
        <div
          className="rounded-[2.5rem] overflow-hidden text-left"
        ...
        >
          <div className="p-10 md:p-12">
            ...
            <Slide delay={0.06}>
              <p className="font-semibold text-lg leading-relaxed mb-5" style={{ color: '#5c0386' }}>
                ...
                {[
                  ...
                  >
                    <img
                      ...
                      style={{ filter: 'invert(11%) sepia(99%) saturate(7492%) hue-rotate(273deg) brightness(70%) contrast(114%)' }}
                    />
