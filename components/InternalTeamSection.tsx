  ...
  return (
    <section ref={ref} className="py-20 px-6 bg-white">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <span className="inline-block text-xs font-bold tracking-widest uppercase mb-4" style={{ color: '#5c0386' }}>
            For Teams With Internal Resources
          </span>
          <h2 className="text-4xl md:text-6xl font-bold text-geko-dark mb-6 leading-tight">
            Already Have An Internal Team?
          </h2>
          <p className="text-xl md:text-2xl font-bold text-geko-dark">
        ...
        {/* Main card */}
        <div
          className="rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-700 delay-200"
          style={{
            opacity: visible ? 1 : 0,
        ...
        >
          ...
          <div className="p-10 md:p-14">
            <p className="text-white/80 text-lg leading-relaxed mb-8">
              Your marketing team doesn't need replacing. They need more creative capacity, specialized expertise, and strategic support to execute consistently at a high level.
            </p>
          ...
          {/* Feature pills */}
          <div className="px-10 md:px-14 pb-10 md:pb-14 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
