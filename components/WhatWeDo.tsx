...
export const WhatWeDo: React.FC = () => {
  return (
    <section id="services" className="bg-white py-24">
      <div className="container mx-auto px-6 md:px-12">
        <div className="mb-20">
          ...
          <p className="text-xl md:text-2xl text-gray-600 font-light max-w-4xl leading-relaxed">
            At Sleeka, we function as your dedicated creative department, providing the design,
              ...
              <div className="space-y-4">
                {services.map((s, idx) => (
                  <div key={idx} className="flex items-center gap-4 py-3 border-b border-gray-300/50 group/item cursor-pointer hover:translate-x-2 transition-transform">
                    <span className="text-gray-400 group-hover/item:text-geko-accent transition-colors">{s.icon}</span>
      ...
      <style>{`.stroke-text { -webkit-text-stroke: 2px #0B4635; color: transparent; }`}</style>
    </section>
  );
};
