          ...
          {talents.map((talent, index) => (
            <div key={index} className="group cursor-pointer">
              <div className="relative aspect-[3/4] rounded-[2rem] overflow-hidden mb-6 bg-gray-200">
                ...
                <div className="absolute bottom-6 left-6 right-6 opacity-0 group-hover:opacity-100 overflow-hidden transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
